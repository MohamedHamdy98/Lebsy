package com.momoandroid.lebsy.view.activitiesCategory.uiFurniture.kids;
...
public class KidsFragment extends Fragment {
    ...
    private KidsViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(KidsViewModel.class);
